...
class AcquisitionWorker(QObject):
    ...
    def __init__(self, camera_worker, save_dir, n_steps, timepoints, n_channels, n_positions,
             channel_names=None, mode = "standard", max_volume_queue=10, save_type="TIFF"):
        """
        ...
        self.n_frames = self.n_steps * self.timepoints * len(self.channel_names) * self.n_positions
        self.n_volumes = self.timepoints * len(self.channel_names) * self.n_positions
