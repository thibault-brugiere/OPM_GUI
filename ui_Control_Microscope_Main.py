...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_Laser_561 = QAction(MainWindow)
        self.action_Laser_561.setObjectName(u"action_Laser_561")
        self.action_UI_Laser = QAction(MainWindow)
        self.action_UI_Laser.setObjectName(u"action_UI_Laser")
        ...
        self.action_Sample_finder = QAction(MainWindow)
        self.action_Sample_finder.setObjectName(u"action_Sample_finder")
        self.action_RFS = QAction(MainWindow)
        self.action_RFS.setObjectName(u"action_RFS")
        ...
        self.menuShortcuts = QMenu(self.menuAlign)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_UI_Laser.setText(QCoreApplication.translate("MainWindow", u"UI Laser", None))
        ...
        self.action_Sample_finder.setText(QCoreApplication.translate("MainWindow", u"Sample finder", None))
        self.action_RFS.setText(QCoreApplication.translate("MainWindow", u"O2-O3 stabilisation", None))
...
#if QT_CONFIG(tooltip)
        self.label_daq_detected.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>If noNi DAQ has been detected, after checking the camera connection, restart the interface.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
"Acquisition", None))
        ...
        self.menuShortcuts.setTitle(QCoreApplication.translate("MainWindow", u"Shortcuts", None))
