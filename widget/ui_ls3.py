...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.slider_x_position.setMaximum(99)
        self.slider_x_position.setOrientation(Qt.Horizontal)

        self.gridLayout.addWidget(self.slider_x_position, 1, 1, 1, 1)

        self.slider_y_position = QSlider(Form)
        self.slider_y_position.setObjectName(u"slider_y_position")
        self.slider_y_position.setOrientation(Qt.Vertical)

        self.gridLayout.addWidget(self.slider_y_position, 0, 0, 1, 1)

        self.label_mainImage = WheelLabel(Form)
        ...
        self.gridLayout.addWidget(self.label_mainImage, 0, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.slider_x_position.setToolTip(QCoreApplication.translate("Form", u"<html><head/><body><p>Navigate through time to display a specific volume.</p></body></html>", None))
